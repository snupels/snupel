...
export const BADGE_CATALOG: BadgeDefinition[] = [
  ...
  { id: 3, ruleKey: "summit_1000m", name: "정상 정복자", description: "해발 1,000m 이상 정상 방문 미션 완료", icon: "medal", missionAvailable: true },
  ...
  { id: 11, ruleKey: "first_sunrise", name: "선라이즈 헌터", description: "일출 명소 미션 완료", icon: "cloudSun", missionAvailable: true },
