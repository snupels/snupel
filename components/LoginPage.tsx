      ...
      <main className="grid flex-1 place-items-center bg-gradient-to-br from-[#e6f0e9] via-white to-[#f3f7f4] px-4 py-10">
        <div className="w-full max-w-md rounded-[28px] border border-white bg-white/95 p-7 shadow-[0_28px_80px_rgba(24,67,47,0.16)] sm:p-9">
          ...
          <form onSubmit={submit} className="mt-8 space-y-5">
            ...
            {signup && <div className="grid grid-cols-2 gap-2"><Link href="/terms/service" target="_blank" className="rounded-xl border border-[#dfe5e1] px-3 py-2 text-center text-xs font-bold text-[#008f45]">이용약관 보기</Link><Link href="/terms/privacy" target="_blank" className="rounded-xl border border-[#dfe5e1] px-3 py-2 text-center text-xs font-bold text-[#008f45]">개인정보 동의 보기</Link></div>}
