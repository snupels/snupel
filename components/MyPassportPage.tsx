      ...
      <div className="mx-auto max-w-[1180px] px-4 py-14 sm:px-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.6fr)_minmax(300px,0.9fr)]">
          ...
          <aside className="space-y-6">
            ...
            <section className="rounded-[24px] border border-[#daceaf] bg-[#fffaf0] p-6"><span className="rounded-full bg-[#f4e8c9] px-3 py-1 text-xs font-bold text-[#87691e]">향후 혜택 계획</span><h2 className="mt-4 text-xl font-bold">패스포트 리워드 미리보기</h2><p className="mt-3 text-sm leading-6 text-[#6f7a87]">숙박 할인권과 기념 굿즈는 아직 발급되지 않습니다. 제휴처와 지급 조건이 확정된 뒤 별도로 안내합니다.</p><Link href="/stampbook#rewards" className="mt-5 flex h-11 items-center justify-center gap-2 rounded-xl border border-[#172c40] text-sm font-bold text-[#172c40] hover:bg-[#172c40] hover:text-white">향후 계획과 유의사항<AppIcon name="arrowRight" className="size-4" /></Link></section>
