      ...
      <section className="relative overflow-hidden px-4 pb-24 pt-12 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto grid min-h-[460px] max-w-[1180px] items-center gap-10 py-10 lg:grid-cols-[1fr_440px]">
          <div className="max-w-2xl text-white">
            ...
            <div className="mt-7 flex flex-wrap gap-3"><Link href="/sports" className="inline-flex h-12 items-center gap-2 rounded-xl bg-white px-6 text-sm font-bold text-[#008f45]">방문 인증하러 가기<AppIcon name="arrowRight" /></Link><a href="/stampbook/" className="inline-flex h-12 items-center rounded-xl border border-white/60 px-6 text-sm font-bold text-white">내 도장북 보기</a></div>
          </div>
      ...
      <section className="mx-auto grid max-w-[1180px] gap-6 px-4 py-14 sm:px-6 lg:grid-cols-[minmax(0,1.65fr)_minmax(300px,0.85fr)]">
        <div className="space-y-6">
          <section id="stamp-book" className="rounded-[24px] border border-[#e0e7e2] bg-white p-6 sm:p-8">
            <div className="flex items-end justify-between gap-4"><div><h2 className="text-2xl font-bold">나의 강원 도장북</h2><p className="mt-2 text-sm text-[#6f7a87]">방문 인증을 완료한 강원 스포츠 코스의 도장을 확인할 수 있어요.</p></div><a href="/stampbook/" className="inline-flex shrink-0 items-center gap-1 text-sm font-bold text-[#008f45]">전체보기<AppIcon name="arrowRight" className="size-4" /></a></div>
