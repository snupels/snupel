      ...
      <section className="mx-auto grid max-w-[1180px] gap-6 px-4 py-14 sm:px-6 lg:grid-cols-[minmax(0,1.65fr)_minmax(300px,0.85fr)]">
        <div className="space-y-6">
          <section id="stamp-book" className="rounded-[24px] border border-[#e0e7e2] bg-white p-6 sm:p-8">
            <div className="flex items-end justify-between gap-4"><div><h2 className="text-2xl font-bold">나의 강원 도장북</h2><p className="mt-2 text-sm text-[#6f7a87]">방문 인증을 완료한 강원 스포츠 코스의 도장을 확인할 수 있어요.</p></div><Link href="/passport" className="inline-flex shrink-0 items-center gap-1 text-sm font-bold text-[#008f45]">전체보기<AppIcon name="arrowRight" className="size-4" /></Link></div>
