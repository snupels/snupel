  ...
  return (
    <div className="min-h-screen bg-[#f4f7f5] text-[#172033]">
      <main className="mx-auto max-w-[1180px] px-5 pb-20 pt-12 sm:px-8 sm:pt-16">
        ...
        <header className="mt-10"><h1 className="text-4xl font-bold tracking-[-0.04em]">나의 배지</h1><p className="mt-3 text-[#737f78]">획득한 배지 {badges.length}개 / 전체 {BADGE_CATALOG.length}개 · 스포츠 도전의 기록을 모아 보세요.</p><p className="mt-3 text-sm leading-6 text-[#737f78]">여기서는 디지털 배지와 실물 배지 세트만 관리합니다. 숙박 할인권·브랜드 굿즈는 별도의 패스포트 리워드입니다.</p><Link href="/stampbook#rewards" className="mt-4 inline-flex items-center gap-2 rounded-xl border border-[#c7d9ce] px-4 py-3 text-sm font-bold text-[#008343] hover:bg-white">패스포트 리워드 알아보기<AppIcon name="arrowRight" className="size-4" /></Link></header>
        ...
        <section className="mt-10 rounded-[24px] border border-[#dce5df] bg-white p-6 shadow-sm sm:p-8">
          <p className="text-xs font-bold tracking-[0.16em] text-[#008343]">MY BADGE COLLECTION</p><h2 className="mt-2 text-2xl font-bold">디지털 배지 · 실물 배지 세트</h2><p className="mt-3 text-sm leading-6 text-[#737f78]">디지털 배지는 달성 시 기록되고, 실물 배지는 조건 충족 후 배송을 신청할 수 있습니다. 신청 후 운영자가 준비·배송 상태를 안내합니다.</p>
